...
export declare const appRouter: import("@trpc/server").CreateRouterInner<import("@trpc/server").RootConfig<{
    ...
    shows: import("@trpc/server").CreateRouterInner<import("@trpc/server").RootConfig<{
        ctx: object;
        meta: object;
        errorShape: import("@trpc/server").DefaultErrorShape;
        transformer: typeof import("superjson").default;
    }>, {
        listUpcoming: import("@trpc/server").BuildProcedure<"query", {
            _config: import("@trpc/server").RootConfig<{
                ctx: object;
                meta: object;
                errorShape: import("@trpc/server").DefaultErrorShape;
            ...
            _output_in: {
                ...
                continuityItems: {
                    ...
                    media: {
                        ...
                        name: string;
                        durationSeconds: number;
                        state: "Pending" | "Processing" | "Ready" | "ReadyWithWarnings" | "ProcessingFailed" | "Archived";
                        rawPath: string;
                    } | null;
                }[];
                rundowns: {
    ...
    media: import("@trpc/server").CreateRouterInner<import("@trpc/server").RootConfig<{
        ...
        get: import("@trpc/server").BuildProcedure<"query", {
            ...
            _output_in: {
                ...
                tasks: {
                    id: number;
                    state: "Pending" | "Running" | "Complete" | "Failed" | "Warning";
                    description: string;
                    media_id: number;
        ...
        bulkGet: import("@trpc/server").BuildProcedure<"query", {
            _config: import("@trpc/server").RootConfig<{
                ctx: object;
                meta: object;
                errorShape: import("@trpc/server").DefaultErrorShape;
    ...
    rundowns: import("@trpc/server").CreateRouterInner<import("@trpc/server").RootConfig<{
        ctx: object;
        meta: object;
        errorShape: import("@trpc/server").DefaultErrorShape;
        transformer: typeof import("superjson").default;
    ...
    metaFields: import("@trpc/server").CreateRouterInner<import("@trpc/server").RootConfig<{
        ctx: object;
        meta: object;
        errorShape: import("@trpc/server").DefaultErrorShape;
        transformer: typeof import("superjson").default;
    }>, {
        put: import("@trpc/server").BuildProcedure<"mutation", {
            _config: import("@trpc/server").RootConfig<{
                ctx: object;
                meta: object;
                errorShape: import("@trpc/server").DefaultErrorShape;
